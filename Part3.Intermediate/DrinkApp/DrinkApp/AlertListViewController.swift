...
class AlertListViewController: UITableViewController{
    ...
    var alerts: [Alert] = []
    let userNoticaionCenter = UNUserNotificationCenter.current()
    ...
    @IBAction func addAlertButtonAction(_ sender: UIBarButtonItem) {
        ...
        addAlertVC.pickedDate = {[weak self] date in
            ...
            self.userNoticaionCenter.addNotificationRequest(by: newAlert)
...
extension AlertListViewController{
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        switch editingStyle{
        case .delete:            
            userNoticaionCenter.removePendingNotificationRequests(withIdentifiers: [alerts[indexPath.row].id])
